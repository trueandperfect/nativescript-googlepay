export declare enum GooglePayAuthMethods {
    /**
...
export declare enum GooglePayCardNetworks {
    'AMEX' = "AMEX",
    'DISCOVER' = "DISCOVER",
    'INTERAC' = "INTERAC",
    'JCB' = "JCB",
...
export declare enum GooglePayEvents {
 ...
 */
export declare enum TokenizationSpecificationType {
    /**
 ...
 */
export declare enum BillingAddressParametersFormat {
    /**
 ...
 */
export declare enum AllowedPaymentMethodsType {
    CARD = "CARD"
}
export declare enum TotalPriceStatusValue {
    /**
 ...
 */
export declare enum CheckoutOptionValue {
    /**
